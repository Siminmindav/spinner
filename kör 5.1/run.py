...
kijelző = pygame.display.set_mode((1335, 400))
pygame.display.set_caption("válassz nyelvet/choose language/eliges idioma/Выберите язык")
...
while choosing == 1:
    for event in pygame.event.get():
        if event.type == pygame.QUIT:
            pygame.quit()
            sys.exit()
    kijelző.blit(pygame.font.SysFont("Arial", 24).render("Válassz egy nyelvet! / Choose a language! / ¡Eliges idioma! / Выберите язык!", False, (255,255,255)), (260, 20))
    ...
    kijelző.blit(loader.images["español"], (685, 100))
    kijelző.blit(pygame.font.SysFont("Arial", 24).render("español", False, (255,255,255)), (795, 250))
    kijelző.blit(loader.images["русский"], (1020, 100))
    kijelző.blit(pygame.font.SysFont("Arial", 24).render("русский", False, (255,255,255)), (1129, 250))
    if event.type == pygame.MOUSEBUTTONDOWN:
        ...
        if onclick(685,100,300,150):
            nyelv = "español"
        if onclick(1020,100,300,150):
            nyelv = "русский"
        print(f"chosen language: {nyelv}")
        if onclick(675, 300, 80, 50) and nyelv:
            choosing = 0
    if nyelv:   
        pygame.draw.rect(kijelző,(255,255,255),(675, 300, 80, 50), 5)
        pygame.draw.rect(kijelző,(0,0,0),(575, 310, 95, 50))
        kijelző.blit(pygame.font.SysFont("Arial", 24).render(nyelv, False, (255,255,255)), (575, 310))      
        kijelző.blit(pygame.font.SysFont("Arial", 24).render("OK", False, (255,255,255)), (695, 310))      
...
if nyelv == "русский":
    from textRU import caption, instructions, variables, fps, developer

kijelző = pygame.display.set_mode((1000,800)) #3800,2100 1000, 800
#kijelző = pygame.display.set_mode(pygame.display.get_desktop_sizes()[0]) 
...
while True: 
    ...
    if perf[0] == -1:
        ...
        if nyelv == "magyar":
            ...
            kijelző.blit(loader.images["красный"], (90,660))
            kijelző.blit(loader.images["зеленый"], (160,660))
            kijelző.blit(loader.images["синий"], (230,660))
